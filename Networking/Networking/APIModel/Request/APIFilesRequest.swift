...
public struct APIFilesRequest: APIModelType {
    ...
    public init(path: String, isRecursive: Bool = false, includeMediaInfo: Bool = true, includeDeleted: Bool = false, includeHasExplicitSharedMembers: Bool = false, includeMountedFolders: Bool = false, includeNonDownloadableFiles: Bool = false) {
        self.path = path
